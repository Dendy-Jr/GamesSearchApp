...
class GamesRepositoryTest : BaseGamesRepositoryTest() {
    ...
    private val mapperData = TestToGameDataMapper()
    private val mapperCache = TestToGameCacheMapper()
    private lateinit var repository: GamesRepository

    @Before
    fun setUp() {
        val cloudDataSource = GamesCloudDataSource.Test()
        val cacheDataSource = GamesCacheDataSource.Test()
        repository = TestGamesRepository(cloudDataSource, cacheDataSource, mapperCache, mapperData)
    }
